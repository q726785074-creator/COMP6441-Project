...
Response: Demo Mode uses a temporary state, labels its values as demonstration data, blocks formal summary download, and restores previous formal progress when exited.
